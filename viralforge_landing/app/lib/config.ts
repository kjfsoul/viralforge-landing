...
export const config = {
  ...
  printify: {
    ...
    mysticArcanaProductUrl: process.env.PRINTIFY_MYSTIC_ARCANA_PRODUCT_URL || '',
    edmShuffleProductUrl: process.env.PRINTIFY_EDM_SHUFFLE_PRODUCT_URL || '',
    birthdayGenProductUrl: process.env.PRINTIFY_BIRTHDAY_GEN_PRODUCT_URL || '',
  },
  ...
  social: {
    ...
    twitterShareUrl: process.env.NEXT_PUBLIC_TWITTER_SHARE_URL || 'https://twitter.com/intent/tweet',
  ...
  // Mock images
  mockImages: {
    pinimg1: process.env.MOCK_IMAGES_PINIMG1 || '',
    pinimg2: process.env.MOCK_IMAGES_PINIMG2 || '',
    amazon1: process.env.MOCK_IMAGES_AMAZON1 || '',
    amazon2: process.env.MOCK_IMAGES_AMAZON2 || '',
    teepublic: process.env.MOCK_IMAGES_TEEPUBLIC || '',
    etsy: process.env.MOCK_IMAGES_ETSY || '',
  },
