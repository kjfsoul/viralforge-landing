...
const brands = [
  {
    ...
    image: 'getImageUrl("b36fadd6-3502-4b2d-a43a-f78f49504cd2")',
    icon: Star,
    color: 'from-purple-500 to-pink-500',
    hoverColor: 'hover:shadow-purple-500/25',
    borderColor: 'border-purple-500',
    website: 'config.external.mysticArcana',
    social: {
      instagram: 'config.social.instagramMysticArcana',
      tiktok: 'config.social.tiktokMysticArcana',
      twitter: 'config.social.twitterMysticArcana'
    },
  ...
  },
  {
    ...
    image: 'getImageUrl("c12bfc8e-745e-4bdd-9d2b-5d40f84c4585")',
    icon: Music,
    color: 'from-cyan-500 to-blue-500',
    hoverColor: 'hover:shadow-cyan-500/25',
    borderColor: 'border-cyan-500',
    website: 'config.external.edmShuffle',
    social: {
      instagram: 'config.social.instagramEDMShuffle',
      tiktok: 'config.social.tiktokEDMShuffle?lang=en',
      twitter: 'config.social.twitterEDMShuffle'
    },
  ...
  },
  {
    ...
    image: 'getImageUrl("815c7bcd-9c6f-4e22-96f8-f9ef7ee79eec")',
    icon: Gift,
    color: 'from-pink-500 to-yellow-500',
    hoverColor: 'hover:shadow-pink-500/25',
    borderColor: 'border-pink-500',
    website: 'config.external.birthdayGen',
    social: {
      instagram: 'config.social.instagramBirthdayGen',
      tiktok: 'config.social.tiktokBirthdayGen?lang=en',
      twitter: 'config.social.twitterBirthdayGen'
    },
